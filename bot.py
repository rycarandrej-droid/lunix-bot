...
JOKES = [
    ...
    "— Почему у программистов путается Новый год?\n— Потому что они пишут 2026 вместо 2025, думая, что ещё успеют.",
]
...
# ==== КОРНИ ПЛОХИХ СЛОВ (ловят все формы) ====
BAD_WORDS = [
    # Оскорбления (корни)
    ...
    "псих", "шизик", "ненормальн", "придурошн",
    
    # Мат (корни)
    "хуй", "хуя", "хую", "хуё", "хуи", "хуйн",
    "пизд", "пиздец", "бляд", "блят", "блядь",
    "ебал", "ебан", "ебат", "ебуч", "ебля", "ебну",
    "ёбал", "ёбан", "ёбат", "ёбуч", "ёбля", "ёбну",
    "заеба", "заёба", "заебис", "заёбис",
    "отъеб", "отъёб", "отъебис", "отъёбис",
    "выеб", "выёб", "въеб", "въёб",
    "наеб", "наёб", "наебал", "наёбал",
    "долбоёб", "долбоеб", "долбоящер",
    "сук", "сука", "суки", "суч", "сучк", "сучон",
    "мудак", "мудил", "мудень", "мудозвон",
    "гандон", "гондон", "гандо",
    "шлюх", "шалав", "шалавы",
    "дроч", "дрочи", "дрочун",
    "залуп", "залупой",
    ...
    "педик", "гомик", "гомосек",
    "жоп", "жопа", "жопу", "жопой",
    "говн", "говно", "говнюк", "говнищ",
    "срак", "срака", "срать", "срал",
    "сса", "ссать", "ссы", "ссыкло", "ссыкун",
    "похуй", "похую", "похуис",
    "нахуй", "нахуя", "нахуярь",
    "охуе", "охуел", "охуенно", "охуительн",
    "ахуе", "ахуел", "ахуенно", "ахуительн",
