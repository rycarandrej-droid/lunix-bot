...
TOPICS_GOOD = {
    ...
    "умеешь": [
        ...
        "Поговорить, пошутить, поиграть в кубик или монетку 🙂",
    ],
    "можешь": [
        "Много чего 🙂 Рассказать анекдот, поиграть, поболтать 🙂",
    ...
    "помочь": [
        "Конечно 🙂 Расскажи, что нужно",
        "Попробую 🙂 В чём вопрос?",
        "Слушаю 🙂 Что случилось?",
    ],
    "help": ["Слушаю 🙂 Что нужно?", "Помогу чем смогу 🙂"],
    "помоги": ["Расскажи, что случилось 🙂", "Слушаю 🙂"],
    "функци": [
        "Команды: /mode /mood /invite /joke /dice /coin /evil /good /reset 🙂",
        "Могу: анекдот, кубик, монетка, режимы, приглашения 🙂",
    ],
    "команд": [
        "Команды: /mode /mood /invite /joke /dice /coin /evil /good /reset 🙂",
        "Много команд 🙂 Напиши /start чтобы увидеть",
    ],
    "рассказать анекдот": ["Расскажу 🎭 Слушай:", "Сейчас 🙂"],
    "анекдот": ["🎭 " + random.choice(JOKES) if False else "Расскажу 🙂", "Сейчас расскажу 🎭"],

    # ==== ИЗВИНЕНИЯ ====
    "извини": [
        "Да ладно, проехали 🙂", "Всё ок!", "Ничего страшного 🙂",
        "Забыли!", "Бывает 🙂", "Да не парься!",
    ],
    "прости": [
        "Да ладно, всё норм 🙂", "Забыли!", "Ничего 🙂",
        "Да брось, ерунда!", "Ок, проехали 🙂",
    ],
    "сорри": ["Ок, проехали 🙂", "Ничего страшного!", "Да ладно 🙂"],
    "sorry": ["Всё ок 🙂", "Забыли!", "Да не парься 🙂"],
    "виноват": [
        "Да ладно, все мы люди 🙂", "Ничего, бывает!",
        "Проехали 🙂", "Да брось!",
    ],
    "прощаешь": [
        "Конечно 🙂", "Да ладно, не парься!", "Всё ок!",
        "А как же 🙂", "Куда я денусь 😄",
    ],
...
def build_reply(text, mode, history, name, mood, last_action):
    ...
    if "магический шар" in t or "шар" in t:
